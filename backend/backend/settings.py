...
SECRET_KEY = 'django-insecure-scnlw63g1pph4*i(l(9!+rca+b$=si(_#1=$0d)sxympupe+ij'
...
MIDDLEWARE = [
    ...
    'corsheaders.middleware.CorsMiddleware',  # Add this line for CORS handling
